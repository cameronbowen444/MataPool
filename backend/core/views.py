...
from .serializers import LoginSerializer, RegisterSerializer, UserSerializer, EventSerializer
...
def home(request):
    ...
    return Response({"message": "Here are some carpools from the database"})
